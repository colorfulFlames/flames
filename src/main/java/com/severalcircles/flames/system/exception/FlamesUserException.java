...
/**
 * A FlamesUserException is an exception caused by a user. It is thrown when a user does something that is not allowed. Naughty user.
 * @since Flames 8
...
public class FlamesUserException extends FlamesException {
     ...
     * @since Flames 8
     */
    public FlamesUserException(String message) {
        super(message);
    }
}
