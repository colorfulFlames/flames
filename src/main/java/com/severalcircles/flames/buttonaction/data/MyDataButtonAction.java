...
public class MyDataButtonAction implements ButtonAction {
    ...
    public void execute(ButtonClickEvent event, FlamesUser sender) {
        ...
        event.editMessageEmbeds(embed).setActionRow(net.dv8tion.jda.api.interactions.components.Button.success("mydata", "My Data"), net.dv8tion.jda.api.interactions.components.Button.primary("stats", "Stats"), Button.primary("funFacts", "Fun Facts")).queue();
