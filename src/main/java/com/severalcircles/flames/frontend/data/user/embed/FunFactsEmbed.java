...
public class FunFactsEmbed implements FlamesEmbed {
    ...
    public MessageEmbed get() {
        ...
        MessageEmbed embed = new EmbedBuilder()
                ...
                .addField(resources.getString("happyDay"), StringUtils.prettifyDate(funFacts.getHappyDay()), true)
                .addField(resources.getString("sadDay"), StringUtils.prettifyDate(funFacts.getSadDay()), true)
                .addField(resources.getString("highScore"), funFacts.getHighestFlamesScore() + "", true)
                .addField(resources.getString("lowScore"), funFacts.getLowestFlamesScore() + "", true)
